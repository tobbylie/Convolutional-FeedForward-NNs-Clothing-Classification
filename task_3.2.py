...
# create images trian list for reshaping and adding new dimension
images_train_list = []
...
# cnn
model = Sequential()
# convolution layer, 48 feature detectors, kernel size 3x3, relu activation function
# stride 1 and no padding
model.add(Conv2D(48, (3, 3), padding='valid', strides=1, activation='relu', input_shape=images_train_list.shape[1:]))
# max pooling layer with pool size 2x2
model.add(MaxPooling2D(pool_size=(2, 2)))
# convolution layer, 96 feature detectors, kernel size 3x3, relu activation function
# stride 1 and no padding
model.add(Conv2D(96, (3, 3), padding='valid', strides=1, activation='relu'))
# max pooling layer with pool size 2x2
model.add(MaxPooling2D(pool_size=(2, 2)))
...
# get confusion matrix from test labesl and predictions
